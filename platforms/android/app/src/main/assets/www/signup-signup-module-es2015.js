...
let SignupPage = class SignupPage {
    constructor(toastCtrl, router, service) {
    ...
    next() {
        ...
        let request1 = { mobile_no: this.mobile.toString(), name: this.email };
        console.log('user register', request1);
        this.service.signUp(request1).subscribe((res) => {
            console.log('res', res);
        }, error => {
            console.log('error', error);
        });
        let request = { mobile_no: this.mobile.toString() };
        console.log('user data', request);
        this.service.otp(request).subscribe((res) => {
            console.log('res', res);
        }, error => {
            console.log('error', error);
        });
...
SignupPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])
], SignupPage);
